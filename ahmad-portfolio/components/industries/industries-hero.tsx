        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <ScrollReveal delay={0.2}>
            <p className="text-xl text-[#4a5568] leading-relaxed mb-8 max-w-3xl mx-auto">
              Helping organizations across multiple industries improve operational efficiency, reduce manufacturing cost, 
              optimize production systems, and digitally transform operations through Artificial Intelligence, 
              Lean Manufacturing, and Smart Factory solutions.
            </p>
          </ScrollReveal>

          <ScrollReveal delay={0.3}>
            <p className="text-lg text-[#4a5568] leading-relaxed max-w-3xl mx-auto">
              Every industry faces different operational challenges. My approach focuses on designing customized, 
              data-driven, and scalable solutions based on industry-specific production systems, operational requirements, 
