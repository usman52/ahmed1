  ...
  useEffect(() => {
    const ctx = gsap.context(() => {
      ...
      gsap.from('.contact-card', {
        ...
        scrollTrigger: { trigger: '.contact-hero', start: 'top 60%' },
      });

      gsap.from('.area-pill', {
        scale: 0, opacity: 0, duration: 0.3, stagger: 0.03, ease: 'back.out(1.7)',
        scrollTrigger: { trigger: '.areas-section', start: 'top 75%' },
      });

      gsap.from('.industry-tag', {
        y: 20, opacity: 0, duration: 0.4, stagger: 0.08, ease: 'power3.out',
        scrollTrigger: { trigger: '.industries-section', start: 'top 75%' },
      });

      gsap.from('.opp-item', {
        x: -40, opacity: 0, duration: 0.5, stagger: 0.06, ease: 'power3.out',
        scrollTrigger: { trigger: '.opportunities-section', start: 'top 75%' },
      });
