  ...
  useEffect(() => {
    ...
    const ctx = gsap.context(() => {
      ...
      gsap.from('.achievement-stat', {
        ...
        scrollTrigger: { trigger: '.achievements-grid', start: 'top 75%', once: true },
      });
      ...
      gsap.from('.profile-card', {
        ...
        scrollTrigger: { trigger: '.profiles-section', start: 'top 75%', once: true },
      });

      gsap.from('.download-cta > *', {
        y: 40, opacity: 0, duration: 0.7, stagger: 0.15, ease: 'power3.out',
        scrollTrigger: { trigger: '.download-cta', start: 'top 75%', once: true },
      });
    }, pageRef);
